...
package dev.architectury.plugin.mojmapextensions;

import dev.architectury.plugin.mojmapextensions.extensions.PluginExtension;
import dev.architectury.plugin.mojmapextensions.tasks.*;
import org.gradle.api.Plugin;
import org.gradle.api.Project;
import org.gradle.api.tasks.TaskContainer;

public class MojmapExtensionsPlugin implements Plugin<Project> {
    @Override
    public void apply(Project project) {
        project.getExtensions().create("mojmap", PluginExtension.class, project);
